...
from PysparkRepo.src.assignment_3.utils import pivot, unpivot
...
class MyTestCase(unittest.TestCase):
    ...
    def test_select_column(self):
        ...
        colName= "country"
        self.expected_result=select_column(self.df,colName)
        schema = StructType([
    ...
    def test_add_value_col(self):
        expected_result=add_value_col(self.df,'salary')
        schema = StructType([
    ...
    def test_distinct_values(self):
        expected_result = distinct_values(self.df,'salary')
        schema = StructType([
            StructField("salary", IntegerType())
        ])
